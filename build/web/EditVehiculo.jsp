        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
         ...
         <!-- Formulario -->
            <form class="bg-light container-md mt-5 mb-5 " action="ControladorVehiculo" method="POST">
                <center><h2 class="mt-2 mb-2"> EDITAR VEHICULO &nbsp;&nbsp;<i class="fas fa-bus"></i></h2> </center>
                <div>
                    <input type="hidden" class="form-control" autocomplete="off" name="ingresoMatricula" value="${vehiculo.getMatricula()}" required>
                </div>                
                <div>
                    <b><label for="ingresoAliasVehiculo" class="mt-2">ALIAS</label></b>
                    <input type="text" class="form-control" autocomplete="off" name="ingresoAliasVehiculo" placeholder="Ingrese alias" value="${vehiculo.getAliasVehiculo()}">
                </div>
                <div>
