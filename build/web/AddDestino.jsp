...
<html>
    ...
    <body>
        ...
        <form class="bg-light container-md mt-5 mb-5 " action="ControladorDestino" method="POST">
            <center><h2 class="mt-2 mb-2"> REGISTRO DE DESTINOS &nbsp;&nbsp;&nbsp;<i class="fas fa-pen-alt"></i></h2> </center>
            <div>
                <b><label for="ingresoIdDestino" class="mt-2">ID DESTINO</label></b>
                <input type="text" class="form-control" autocomplete="off" name="ingresoIdDestino" placeholder="Ingrese ID del destino"  maxlength="25" required>
            </div>
            <div>
