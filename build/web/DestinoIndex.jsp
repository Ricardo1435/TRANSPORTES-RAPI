        ...
        <div class="p-4">
            <table class="table table-bordered table-striped m-auto">
                ...
                <tr>
                    ...
                    <th colspan="2"><h5><center>VEHICULO</center></h5> </th>
                    ...
                    <c:forEach var="dato" items="${datos}">
                        <tr>
                            ...
                            <center> 
                                ...
                                <button class="btn btn-danger" type="button" id="btnEliminarDestino" value="${dato.getIdDestino()}">Eliminar&nbsp;<i class="fas fa-trash-alt"></i></button>
                                </form>
                            </center>    
                            </td>
                        </tr>
