...
<div id="myModal" class="modal-dialog">
    <div class="modal-dialog modal-confirm">
       <div class="modal-content">
		...
		<p>La cuenta ya se encuentra en uso, porfavor ingresa un nuevo correo.</p>
		</div>
		<div class="modal-footer">
                   <a href="registro.jsp"> <input type="button" class="btn btn-outline-info" value="ACEPTAR"  id="btnAceptar"></a> 
		</div>
		</div>
	</div>
</div>     
