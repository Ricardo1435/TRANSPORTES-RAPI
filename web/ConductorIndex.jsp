...
<html>
    ...
    <body>
        ...
        <div class="container m-auto">
            <div class="navbar">
                <a class="btn btn-outline-success btn-bg my-3 mx-1" id="new" name="accion" value="Nuevo" href="AddConductor.jsp">Nuevo</a>
        ...
        <div class="p-4">
            <table class="table table-bordered table-striped m-auto">
                ...
                <tr>
                    <th colspan="4"><h5><center>CONDUCTORES </center></h5> </th>
                </tr>
                <tr>
                 <th scope="col"><center>ID CONDUCTOR</center></th>
                    ...
                    <c:forEach var="dato" items="${datos}">
                        <tr>
                            ...
                            <center> 
                                ...
                                <input type="hidden" name="idConductor" id="idConductor" value="${dato.getIdConductor()}">
                                <button class="btn btn-warning" type="submit" name="accion" value="Editar">Editar&nbsp;<i class="fas fa-edit"></i></button>
                                <button class="btn btn-danger" type="button" id="btnEliminarConductor" value="${dato.getIdConductor()}">Eliminar&nbsp;<i class="fas fa-trash-alt"></i></button>
                                </form>
                            </center>    
                            </td>
                        </tr>
