...
<html>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link">Editar Viajero <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
        ...
        <form class="bg-light container-md mt-5 mb-5 " action="ControladorViajero" method="POST">
            <center><h2 class="mt-2 mb-2"> EDITAR VIAJERO &nbsp;&nbsp;&nbsp;<i class="fas fa-edit"></i></h2> </center>
       
            <div>
               <input type="hidden" class="form-control" autocomplete="off" name="ingresoRowId" value="${viajero.getRowId()}" required>
            </div> 
            <div>
               <b><label for="ingresoCliente" class="mt-2">CLIENTE</label></b>
                <select class="custom-select" name="ingresoCliente" id="ingresoCliente" required>
                    <option value="${viajero.getIdCliente()}">--Cambiar Cliente--</option>
                    <%
                        try {
            ...
            <div>
               <b><label for="ingresoDestino" class="mt-2">DESTINO</label></b>
                <select class="custom-select" name="ingresoDestino" id="ingresoDestino" required>
                    <option value="${viajero.getIdDestino()}">--Cambiar Destino--</option>
                    <%
                        try {
            ...
            <div>
                ...
                <input type="number" class="form-control" autocomplete="off" name="ingresoAsiento" min="1" pattern="^[0-9]+" placeholder="Ingrese asiento del cliente" value="${viajero.getAsiento()}" required>
            </div>
            <div>
